...
const CardList = ({ cards }) => {
  ...
  return (
    <div className="grid row-1 bg-gradient-to-tl from-gray-300 via-gray-200 to-gray-100 p-28">
      <p className="font-bold text-transparent text-6xl bg-clip-text font-poppin tracking-wider bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 text-center ">
        Flash Cards
      </p>
      <br></br>
      <br></br>
